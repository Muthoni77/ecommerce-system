...
function Resetpassword() {
  ...
  const resetpasswordUser = async (password1, password2) => {
    const resetPasswordResponse = await api.resetPassUser(password1, password2);
  ...
  const formSubmitted = async (event) => {
    ...
    const resetpass = await resetpasswordUser(user.password1, user.password2);
      ...
      <div className="  text-black ">
        ...
        <form className=" flex flex-col " onSubmit={formSubmitted}>
          <div className="flex flex-col ">
            <label className=" text-left" for="password1">
              New Password
            </label>
          ...
          <div className="flex flex-col">
            <div className={loading ? "hidden" : ""}>
              <button
                ...
                disabled={!false}
                className={
                  user.password1.length > 3 && user.password2.length > 3
                    ? "mb-5 h-14 w-96 bg-blue-600 text-white font-bold hover:bg-blue-700 rounded-xl"
                    : "mb-5 h-14 w-96 bg-gray-500 text-white font-bold hover:cursor-not-allowed rounded-xl"
                }
              >
